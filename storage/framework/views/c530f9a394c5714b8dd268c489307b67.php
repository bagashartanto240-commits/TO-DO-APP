                ...
                <div class="glass-card p-4 shadow-sm">
                    ...
                    <form action="<?php echo e(route('todo.store')); ?>" method="POST">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="<?php echo e(route('todo.index')); ?>" class="btn btn-light rounded-pill px-4">
                                Batal
                            </a>
                        </div>
                    </form>
...
</html><?php /**PATH D:\bagashartanto.20236004\TO-DOO\todo-app\resources\views/tambah.blade.php ENDPATH**/ ?>